    ...
    return (
        ...
        <div className="scene" id="welcome">
          <article className="content">
            ...
            <p>The original Landon perseveres after 75 years in the heart of West London. The West End neighborhood has something for everyone—from theater to dining to historic sights. And the not-to-miss Rooftop Cafe is a great place for travelers and locals to engage over drinks, food, and good&nbsp;conversation. &nbsp;To learn more about the Landon Hotel in the West End, browse our website and <a href="files/landon_information_sheet_London.pdf">download our handy information sheet</a>.</p>
          </article>
        </div>
          ...
          <article id="usefulinfo">
            <section id="arrivalinfo">
              ...
              <ul>
                ...
                <li><strong>Parking:</strong> Self-parking in the underground garage is ￡1225 per day and valet-parking is ￡50 per day.</li>
